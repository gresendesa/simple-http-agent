...
message = http.HTTPMessage.Builder(request_line=(b'HTTP/1.1', b'200', b'OK'), headers=[(b'Connection', b'close'), (b'Content-Length', b'6821'), (b'Content-Type', b'text/html')], body=b'teste').get()
